  ...
  (function($, window) {
    ...
    Tour = (function() {
      ...
      Tour.prototype.setState = function(key, value) {
        key = "" + this._options.name + "_" + key + window.location.hash.split('/')[0];
      ...
      Tour.prototype.getState = function(key) {
        ...
        if (this._options.useLocalStorage) {
          value = window.localStorage.getItem("" + this._options.name + "_" + key + window.location.hash.split('/')[0]);
        } else {
          value = $.cookie("" + this._options.name + "_" + key + window.location.hash.split('/')[0]);
        }
        if (value === void 0 || value === "null") {
          value = null;
        }
        this._options.afterGetState(key + window.location.hash.split('/')[0], value);
        return value;
      };
