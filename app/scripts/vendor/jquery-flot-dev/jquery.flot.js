...
(function($) {
    function Plot(placeholder, data_, options_, plugins) {
        ...
        function setupGrid() {
            ...
            // ejnens: disable HTML legend, since we use the legendoncanvas plugin
            /*
            insertLegend();
            */
        }
        ...
        function setupTickGeneration(axis) {
            ...
            if (!axis.tickGenerator) {
                ...
                // ejnens: pass tick index with formatter
                /*
				axis.tickFormatter = function (value, axis) {
                */
				axis.tickFormatter = function (value, axis, tickIndex, tickLength) {
            ...
            if ($.isFunction(opts.tickFormatter))
                ...
                */
                axis.tickFormatter = function (v, axis, tickIndex, tickLength) { return "" + opts.tickFormatter(v, axis, tickIndex, tickLength); };
        ...
        function setTicks(axis) {
            ...
            for (i = 0; i < ticks.length; ++i) {
                ...
                if (label == null)
                    ...
                    */
                    label = axis.tickFormatter(v, axis, i, ticks.length);
                if (!isNaN(v))
