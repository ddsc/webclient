  ...
  dmc.fetch({
    ...
    success: function(collection) {
      ...
      widgetcollectionview.collection.add([
        ...
        new Lizard.Models.Widget({col:3,row:3,size_x:3,size_y:2,gaugeId:5,title:'Debiet links',label:'liter/uur',
          value: values.get('debiet_l') , max: 5000}),
        new Lizard.Models.Widget({col:3,row:5,size_x:3,size_y:2,gaugeId:7,title:'Debiet rechts',label:'liter/uur',
